...
import static com.galopulerev.store.web.rest.TestUtil.sameNumber;
...
import com.galopulerev.store.domain.Product;
import com.galopulerev.store.domain.ProductCategory;
import com.galopulerev.store.domain.enumeration.Size;
import com.galopulerev.store.repository.ProductRepository;
import com.galopulerev.store.service.ProductService;
...
class ProductResourceIT {
    ...
    private static final Size DEFAULT_DIMENSION = Size.S;
    private static final Size UPDATED_DIMENSION = Size.M;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getDimension()).isEqualTo(DEFAULT_DIMENSION);
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getDimension()).isEqualTo(UPDATED_DIMENSION);
