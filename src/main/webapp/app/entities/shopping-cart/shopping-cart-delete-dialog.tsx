...
export const ShoppingCartDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterStoreApp.shoppingCart.delete.question">
        <Translate contentKey="jhipsterStoreApp.shoppingCart.delete.question" interpolate={{ id: shoppingCartEntity.id }}>
