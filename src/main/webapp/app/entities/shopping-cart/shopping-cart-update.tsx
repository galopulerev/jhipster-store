  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterStoreApp.shoppingCart.home.createOrEditLabel" data-cy="ShoppingCartCreateUpdateHeading">
            <Translate contentKey="jhipsterStoreApp.shoppingCart.home.createOrEditLabel">Create or edit a ShoppingCart</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterStoreApp.shoppingCart.placedDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterStoreApp.shoppingCart.status')}
              ...
              >
                {orderStatusValues.map(orderStatus => (
                  <option value={orderStatus} key={orderStatus}>
                    {translate('jhipsterStoreApp.OrderStatus.' + orderStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipsterStoreApp.shoppingCart.totalPrice')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterStoreApp.shoppingCart.paymentMethod')}
              ...
              >
                {paymentMethodValues.map(paymentMethod => (
                  <option value={paymentMethod} key={paymentMethod}>
                    {translate('jhipsterStoreApp.PaymentMethod.' + paymentMethod)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                label={translate('jhipsterStoreApp.shoppingCart.customerDetails')}
                type="select"
                required
              >
                <option value="" key="0" />
