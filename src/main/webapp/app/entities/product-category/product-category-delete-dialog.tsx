...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterStoreApp.productCategory.delete.question">
        <Translate contentKey="jhipsterStoreApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
