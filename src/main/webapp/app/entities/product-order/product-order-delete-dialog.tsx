...
export const ProductOrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterStoreApp.productOrder.delete.question">
        <Translate contentKey="jhipsterStoreApp.productOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
