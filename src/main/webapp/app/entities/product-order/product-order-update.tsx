  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterStoreApp.productOrder.home.createOrEditLabel" data-cy="ProductOrderCreateUpdateHeading">
            <Translate contentKey="jhipsterStoreApp.productOrder.home.createOrEditLabel">Create or edit a ProductOrder</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterStoreApp.productOrder.quantity')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterStoreApp.productOrder.totalPrice')}
              ...
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('jhipsterStoreApp.productOrder.product')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="cart"
                data-cy="cart"
                label={translate('jhipsterStoreApp.productOrder.cart')}
                type="select"
                required
              >
                <option value="" key="0" />
