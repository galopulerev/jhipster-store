  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterStoreApp.customerDetails.home.createOrEditLabel" data-cy="CustomerDetailsCreateUpdateHeading">
            <Translate contentKey="jhipsterStoreApp.customerDetails.home.createOrEditLabel">Create or edit a CustomerDetails</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterStoreApp.customerDetails.gender')}
              ...
              >
                {genderValues.map(gender => (
                  <option value={gender} key={gender}>
                    {translate('jhipsterStoreApp.Gender.' + gender)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipsterStoreApp.customerDetails.phone')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterStoreApp.customerDetails.addressLine1')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterStoreApp.customerDetails.addressLine2')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterStoreApp.customerDetails.city')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterStoreApp.customerDetails.country')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('jhipsterStoreApp.customerDetails.user')}
                type="select"
                required
              >
                <option value="" key="0" />
