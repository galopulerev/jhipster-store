...
export const CustomerDetailsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterStoreApp.customerDetails.delete.question">
        <Translate contentKey="jhipsterStoreApp.customerDetails.delete.question" interpolate={{ id: customerDetailsEntity.id }}>
