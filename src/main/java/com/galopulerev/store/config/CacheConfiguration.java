package com.galopulerev.store.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.galopulerev.store.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.galopulerev.store.repository.UserRepository.USERS_BY_EMAIL_CACHE);
